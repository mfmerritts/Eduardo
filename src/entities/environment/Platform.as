package entities.environment 
{
	 ...
	 * One problem with the current set up that I need to solve is that it only really interacts with the player right now.
	 * If the player is below the onewayfall other objects would fall through it.
	 * ...
